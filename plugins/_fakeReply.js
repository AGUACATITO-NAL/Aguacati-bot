...
handler.all = async function (m) {
   ...
   global.rpl = { contextInfo: { externalAdReply: { mediaUrl: tbgp, mediaType: 'VIDEO', description: 'support group', title: packname, body: 'grupo de soporte', thumbnailUrl: pp, sourceUrl: tbgp }}} 
	...
	//reply link yt
    global.rpyt = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: tbyt, mediaType: 'VIDEO', description: 'Suscribete : ' + tbyt, title: 'AGUACATITONAL TWITCH', body: 'suscríbete a mi canal y apoyame', thumbnailUrl: pp, sourceUrl: tbyt }}}
